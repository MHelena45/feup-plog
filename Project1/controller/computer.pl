...
value(Board, Player, _Move, White_Pieces, Brown_Pieces, 10) :- 
    ...
    setof(Move, (valid_move(0, Move, New_Player, Board, White_Pieces, Brown_Pieces), game_over(0, Board, New_Player, Move, White_Pieces, Brown_Pieces, _Mode)), _List_Of_Moves).

% if we can win in the next play with a play we can't make
value(Board, Player, _Move, White_Pieces, Brown_Pieces, -8) :-
    setof(Move, (valid_move(0, Move, Player, Board, White_Pieces, Brown_Pieces), game_over(0, Board, Player, Move, White_Pieces, Brown_Pieces, _Mode)), _List_Of_Moves).
