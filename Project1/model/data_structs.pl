...
init_board([
    [0, 11, 0, 0],         % 0 represents a empty cell
    [0, 0, 0, 0],
    [91, 0, 51, 0],
    [0, 0, 0, 0]
]).
...
init_white_pieces([
    0, 11,     % white cones are represented by 11 and are 2 available in the start
    0, 51,     % white cube are represented by 51 and are 2 available in the start
    71, 71,     % white cylinder are represented by 71 and are 2 available in the start
    0, 91      % white sphere are represented by 91 and are 2 available in the start
]).
