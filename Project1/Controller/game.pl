...
start :- 
    ...
    display_game(Board, WhitePieces, BrownPieces), % Displaying the main game & the available pieces
...
play(Player, Board, WhitePieces, BrownPieces) :-
    ...
    display_game(NewBoard, WhitePieces, BrownPieces),
    % checkEnd
    changePlayer(Player, NewPlayer), % Changes current player
    play(NewPlayer, NewBoard, WhitePieces, BrownPieces).  % Changes current board
